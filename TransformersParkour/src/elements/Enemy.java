...
//			case 16:
			case 17:
				...
				break;
            default:
                enemyMotion.keepId(0);
                enemyMotion.update(factX,factY);
...
//
//    public MSpriteData enemyAnimationData;
	...
	private void init() {
		...
		case 0:
//			if(img0==null)
//                img0 = Globe.getImage("gaming/bianfu/bianfu.png");
//            img = img0;
//            try {
//                enemyAnimationData = MSpriteLoader.loadMSprite("/gaming/bianfu/bianfu.anu", true, ResourceLoader.getInstance());
//            } catch (Exception e) {
//                e.printStackTrace();
//            }
            enemyMotion = new Motion("/gaming/ground/ground2.anu",480,250);
            enemyMotion.keepId(0);
            this.factX = 650;
			this.factY = 150;
			break;
		case 1:
//            if(img1==null)
//                img1 = Globe.getImage("gaming/smalldragon/smalldragon.png");
//            img = img1;
            enemyMotion = new Motion("/gaming/ground/ground3.anu",480,250);
            enemyMotion.keepId(0);
			this.factX = 650;
			this.factY = 260;
			break;
		case 2:
//            if(img2==null)
//                img2 = Globe.getImage("gaming/dragon/dalong.png");
//            img = img2;
            enemyMotion = new Motion("/gaming/ground/ground4.anu",480,250);
            enemyMotion.keepId(0);
			this.factX = 650;
			this.factY = 250;
			break;
		case 3:
//            if(img3==null)
//                img3 = Globe.getImage("gaming/qie/daqie.png");
//            img = img3;
            enemyMotion = new Motion("/gaming/ground/ground5.anu",480,250);
            enemyMotion.keepId(0);
			this.factX = 650;
			this.factY = 266;
			break;
		case 4:
//            if(img4==null)
//                img4 = Globe.getImage("gaming/samllsnowbow/samllsnowbow.png");
//            img = img4;
            enemyMotion = new Motion("/gaming/sky/sky1.anu",480,250);
            enemyMotion.keepId(0);
			this.factX = 650;
			this.factY = 294;
			break;
		case 5:
//            if(img5==null)
//                img5 = Globe.getImage("gaming/shilaimu/shilaimu.png");
//            img = img5;
            enemyMotion = new Motion("/gaming/sky/sky2.anu",480,250);
            enemyMotion.keepId(0);
			this.factX = 650;
			this.factY = 276;
			break;
		case 6:
//            if(img6==null)
//                img6 = Globe.getImage("gaming/dachou/dachou.png");
//            img = img6;
            enemyMotion = new Motion("/gaming/sky/sky3.anu",480,250);
            enemyMotion.keepId(0);
			this.factX = 650;
			this.factY = 272;
			break;
		case 7:
//            if(img7==null)
//                img7 = Globe.getImage("gaming/snowbow/snowbow.png");
//            img = img7;
            enemyMotion = new Motion("/gaming/sky/sky4.anu",480,250);
            enemyMotion.keepId(0);
			this.factX = 650;
			this.factY = 268;
			break;
		case 8:
//            if(img8==null)
//                img8 = Globe.getImage("gaming/xianrenzhang/xianrenzhang.png");
//            img = img8;
            enemyMotion = new Motion("/gaming/bianfu/bianfu.anu",480,250);
            enemyMotion.keepId(0);
			this.factX = 650;
			this.factY = 266;
			break;
		case 9:
//            if(img9==null)
//                img9 = Globe.getImage("gaming/xiaochou/xiaochou.png");
//            img = img9;
            enemyMotion = new Motion("/gaming/bianfu/bianfu.anu",480,250);
            enemyMotion.keepId(0);
			this.factX = 650;
		...
		case 10:
//            if(img10==null)
//                img10 = Globe.getImage("gaming/xiaoqie/xiaoqie.png");
//            img = img10;
            enemyMotion = new Motion("/gaming/bianfu/bianfu.anu",480,250);
            enemyMotion.keepId(0);
			this.factX = 650;
		...
		case 11:
//            if(img11==null)
//                img11 = Globe.getImage("gaming/xiaoshilaimu/xiaoshilaimu.png");
//            img = img11;
            enemyMotion = new Motion("/gaming/bianfu/bianfu.anu",480,250);
            enemyMotion.keepId(0);
			this.factX = 650;
		...
		case 12:
//            if(img12==null)
//                img12 = Globe.getImage("gaming/xiaoxianren/xiaoxianren.png");
//            img = img12;
            enemyMotion = new Motion("/gaming/ground/ground1.anu",480,250);
            enemyMotion.keepId(0);
			this.factX = 650;
			this.factY = 296;
			break;
		...
		case 14:
			...
			break;
		case 15:
//			img = Globe.getImage("enemy/dici.png");
            enemyMotion = new Motion("/gaming/bianfu/bianfu.anu",480,250);
            enemyMotion.keepId(0);
			this.factX = 650;
			this.factY = 295;
