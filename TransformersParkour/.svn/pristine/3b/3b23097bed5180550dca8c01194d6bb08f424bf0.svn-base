...
public class Globe {
	...
	public static int getnormalCollision(Hero hero,Enemy enemy_m)
	{
		...
		int enemy_w = enemy_m.enemyMotion.getCollied(0)[2];
		int enemy_x = enemy_m.enemyMotion.getCollied(0)[0]+enemy_m.enemyMotion.getSpriteDrawX()+(enemy_w>>1);
		int enemy_y = enemy_m.enemyMotion.getCollied(0)[1]+enemy_m.enemyMotion.getSpriteDrawY();
	...
	public static boolean getchongCollision(Motion motion,Enemy enemy_m)
	{
		...
		int enemy_w = enemy_m.enemyMotion.getCollied(0)[2];
		int enemy_h = enemy_m.enemyMotion.getCollied(0)[3];
		int enemy_x = enemy_m.enemyMotion.getCollied(0)[0]+enemy_m.enemyMotion.getSpriteDrawX()+(enemy_w>>1);
		int enemy_y = enemy_m.enemyMotion.getCollied(0)[1]+enemy_m.enemyMotion.getSpriteDrawY()+(enemy_h>>1);
     ...
     * @param enemy_m
     */
    public static boolean getchongCollision2(Motion motion,Enemy enemy_m)
    {
        int hero_w = motion.getCollied(0)[2];
        int hero_h = motion.getCollied(0)[3];
        int hero_x = motion.getCollied(0)[0]+motion.getSpriteDrawX()+(hero_w>>1);
